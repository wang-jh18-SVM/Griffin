...
dataset_prefix = "griffin_100scenes_random"  # * different for every dataset
v2x_side = "drone-side"
num_cams = 5
...
train_sample_num = 12026  # * different for every dataset
...
ann_file_val = info_root + "griffin_infos_train.pkl"
split_datas_file = f"./data/split_datas/{dataset_prefix}_eval_train.json"
