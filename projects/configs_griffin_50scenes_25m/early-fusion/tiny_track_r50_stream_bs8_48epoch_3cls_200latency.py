...
info_root = f"./data/infos/{dataset_prefix}/{v2x_side}-delay-2/"
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='v2xtrack',
                name=f'{dataset_prefix}_{v2x_side}_tiny_r50_bs{batch_size}x{num_gpus}_{num_epochs}e_3cls_200latency',
            ),
        ),
    ],
)
