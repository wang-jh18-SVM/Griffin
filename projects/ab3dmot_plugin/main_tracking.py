...
def parse_args():
    ...
    parser.add_argument(
        '--det_name',
        type=str,
        default='tiny_track_r50_stream_bs8_24epoch_3cls_coEval_smallRange',
        help='imvoxelnet',
    )
    ...
    parser.add_argument(
        '--split-data-path',
        type=str,
        default='/home/wangjiahao/workspace/v2xtrack/data/split_datas/griffin_35scenes_40m_0216.json',
        help='split-data-path',
    )
    parser.add_argument(
        "--input-path",
        type=str,
        default="/home/wangjiahao/workspace/v2xtrack/projects/work_dirs_griffin_35scenes_40m_0216/vehicle-side/tiny_track_r50_stream_bs8_24epoch_3cls_coEval_smallRange/detection_results_to_kitti",
    )
    parser.add_argument(
        "--output-path",
        type=str,
        default="/home/wangjiahao/workspace/v2xtrack/projects/work_dirs_griffin_35scenes_40m_0216/vehicle-side/tiny_track_r50_stream_bs8_24epoch_3cls_coEval_smallRange/tracking_results_to_kitti",
    )
...
def main_per_cat(cfg, cat, log, ID_start):
    ...
    result_sha = '%s_%s_%s' % (
        ...
        cat,
        cfg.split,
    )  # tiny_track_r50_stream_bs8_24epoch_3cls_coEval_smallRange_Car_val
    det_root = os.path.join(
        cfg.input_path, result_sha
    )  # /home/wangjiahao/workspace/v2xtrack/projects/work_dirs_griffin_35scenes_40m_0216/vehicle-side/tiny_track_r50_stream_bs8_24epoch_3cls_coEval_smallRange/detection_results_to_kitti/tiny_track_r50_stream_bs8_24epoch_3cls_coEval_smallRange_Car_val

    seq_eval = get_subfolder_seq(cfg.dataset, cfg.split, cfg.split_data_path)

    save_dir = os.path.join(
        cfg.output_path, result_sha + '_H%d' % cfg.num_hypo
    )  # '/home/wangjiahao/workspace/v2xtrack/projects/work_dirs_griffin_35scenes_40m_0216/vehicle-side/tiny_track_r50_stream_bs8_24epoch_3cls_coEval_smallRange/tracking_results_to_kitti/tiny_track_r50_stream_bs8_24epoch_3cls_coEval_smallRange_Car_val_H1'
    mkdir_if_missing(save_dir)

    # create eval dir for each hypothesis
    eval_dir_dict = dict()
    for index in range(cfg.num_hypo):
        eval_dir_dict[index] = os.path.join(
            save_dir, 'data_%d' % index
        )  # {0: '/home/wangjiahao/workspace/v2xtrack/projects/work_dirs_griffin_35scenes_40m_0216/vehicle-side/tiny_track_r50_stream_bs8_24epoch_3cls_coEval_smallRange/tracking_results_to_kitti/tiny_track_r50_stream_bs8_24epoch_3cls_coEval_smallRange_Car_val_H1/data_0'}
    ...
    for seq_name in seq_eval:
        ...
        seq_file = os.path.join(
            det_root, seq_name + '.txt'
        )  # /home/wangjiahao/workspace/v2xtrack/projects/work_dirs_griffin_35scenes_40m_0216/vehicle-side/tiny_track_r50_stream_bs8_24epoch_3cls_coEval_smallRange/detection_results_to_kitti/tiny_track_r50_stream_bs8_24epoch_3cls_coEval_smallRange_Car_val/scene-0016-Town06-010.txt
